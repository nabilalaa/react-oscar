        ...
        <div className="overlay w-full h-full bg-[#fca311]/50">
          <section className="about p-4 mt-14 w-full h-full">
            <div className="container">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[30%_70%] lg:grid-cols-[20%_80%] gap-8">
          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(170px,1fr))] gap-4">
            {cast.slice(0, 10).map((actor) => {
              return (
                <div
                  key={actor.id}
                  className="credit rounded-2xl bg-amber-300  flex flex-col justify-between"
                >
                  <img
                    className={`p-2 rounded-tl-2xl rounded-tr-2xl object-cover h-full
